...
\preprint{Preprint submitted to Journal of Renewable and Sustainable Energy
19 March 2016}
...
\begin{table}
    ...
    \begin{tabular}{c|c|c|c}
        ...
        Marsh et al.~\cite{Marsh2015} & SST & Reference~\cite{Rawlings2008} & N/A \\
        Orlandi et al.~\cite{Orlandi2015} & SST & References~\cite{Akins1989,Mertens2003} & N/A \\
        Lam \& Peng~\cite{Lam2016} & SST RANS \& IDDES & N/A & Reference~\cite{Tescione2014} \\
        Nini et al.~\cite{Nini2014} & Spalart--Allmaras & N/A & Reference~\cite{Battisti2011} \\
        Boudreau \& Dumas~\cite{Boudreau2015} & DDES & N/A & N/A \\
        Li et al.~\cite{Li2013} & SST \& Smagorinsky--Lilly LES & Reference~\cite{McLaren2011} & N/A \\
        Howell et al.~\cite{Howell2010} & $k$--$\epsilon$ RNG & Reference~\cite{Howell2010} & N/A
    \end{tabular}
...
Figure~\ref{fig:br-cfd-profiles}. The turbulence kinetic energy was calculated as
\begin{equation}
